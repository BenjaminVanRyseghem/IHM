...
L'interface (\emph{cf.}~Fig.~\ref{fig:interface})choisie est très basique il y a un curseur et une liste en haut, trois colonnes au centre et quatre bouton en bas.
...
En bas se trouve les différents boutons. Les deux bouton à gauche servent à modifié la colonne du centre. 
